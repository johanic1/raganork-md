...
module.exports = {
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || '').trim() || 'Raganork~3d95bc67bfa2ae22143d1ebcb29c5e70:3177523742544d48756e6b3d',
    ...
    STICKER_DATA: process.env.STICKER_DATA || "Martial😎❤‍🔥",
    BOT_NAME: process.env.BOT_NAME || 'Martial😎❤‍🔥',
    ...
    SUDO: process.env.SUDO || "237657160439",
